    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('beneficiary', 'مستفيد'), ('charity_admin', 'مدير جمعية'), ('system_admin', 'مدير نظام')], default='beneficiary', max_length=20, verbose_name='نوع المستخدم')),
